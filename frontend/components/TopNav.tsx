    ...
    <header className="h-16 border-b border-radar-border flex items-center justify-between px-6 bg-radar-dark/90 backdrop-blur-md z-50 shrink-0">
      <div className="flex items-center gap-4">
        <div className="flex items-center gap-2">
          <div className="w-8 h-8 bg-radar-red rounded flex items-center justify-center">
          ...
          <h1 className="font-black text-xl tracking-tighter uppercase">Conflict <span className="text-radar-red">Radar</span> <span className="text-xs text-gray-500 font-normal ml-2">ETHIOPIA v2.4</span></h1>
        </div>
      </div>
      <div className="flex items-center gap-12">
        ...
        <div className="text-center">
          <div className="text-2xl font-black text-radar-red leading-none">24</div>
          <div className="text-[10px] uppercase tracking-widest text-gray-500 mt-1">Active Incidents</div>
        </div>
        <div className="text-center">
          <div className="text-2xl font-black text-radar-orange leading-none">68.2</div>
      ...
      <div className="flex items-center gap-4">
        <div className="flex bg-radar-panel rounded border border-radar-border p-1">
          <button className="px-4 py-1 text-[10px] font-bold uppercase tracking-widest bg-radar-red text-white">Unified Dashboard</button>
        </div>
        <button className="px-4 py-2 bg-radar-border text-xs font-bold uppercase tracking-widest hover:bg-radar-red transition-colors duration-300">Export Report</button>
      </div>
    </header>
  );
}
